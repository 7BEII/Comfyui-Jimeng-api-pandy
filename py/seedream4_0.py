...
"""
    ...
    def generate_images(self, prompt, api_key, batch_size, width, height, guidance_scale,
        ...
        # 格式化尺寸
        resolution = self.format_size_for_api(width, height)
        ...
        current_progress = 0
        # 格式化尺寸
        size_str = self.format_size_for_api(width, height)
...
# 节点注册
NODE_CLASS_MAPPINGS = {
    "JM:Seedream 4.0_1": Seedream_40
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "JM:Seedream 4.0_1": "JM:Seedream 4.0_1"
}
